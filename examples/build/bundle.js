...
selectorFactory) {
  ...
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    ...
    return 'ConnectAdvanced(' + name + ')';
      ...
      connectOptions = _objectWithoutProperties$1(_ref, ['getDisplayName', 'methodName', 'renderCountProp', 'shouldHandleStateChanges', 'storeKey', 'withRef']);
...
var FetchJSON = connect(function (state, props) {
  return {
    data_list: state
  };
  ...
  function _class2() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref3 = _class2.__proto__ || _Object$getPrototypeOf(_class2)).call.apply(_ref3, [this].concat(args))), _this), _this.state = {
      data: null,
      error: null
  ...
  _createClass(_class2, [{
    ...
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var _props, _props$method, method, _props$params, params, _props$token, token, otherConfig, url_for_this_request, body, headers, result, data;

        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _props = this.props, _props$method = _props.method, method = _props$method === undefined ? 'get' : _props$method, _props$params = _props.params, params = _props$params === undefined ? null : _props$params, _props$token = _props.token, token = _props$token === undefined ? "" : _props$token, otherConfig = _objectWithoutProperties(_props, ['method', 'params', 'token']);
                url_for_this_request = this.props.url;
                body = params ? serialize(params) : params;
                headers = new Headers(buildHeaders(token));
                _context.prev = 4;
                _context.next = 7;
                return fetch(this.props.url, _extends$1({
                  method: method,
                  body: body,
                  headers: headers
                }, otherConfig));
