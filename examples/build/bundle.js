...
var id$1=react.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner;function jd(a){a=a.type;return"string"===typeof a?a:"function"===typeof a?a.displayName||a.name:null}
...
var cf=af(!1);
function df(a,b,c,d,e){function f(a,b,c){var d=b.expirationTime;b.child=null===a?cf(b,null,c,d):bf(b,a.child,c,d);}function g(a,b){var c=b.ref;null===c||a&&a.ref===c||(b.effectTag|=128);}function h(a,b,c,d){g(a,b);if(!c)return d&&re(b,!1), q(a,b);c=b.stateNode;id$1.current=b;var e=c.render();b.effectTag|=1;f(a,b,e);b.memoizedState=c.state;b.memoizedProps=c.props;d&&re(b,!0);return b.child}function k(a){var b=a.stateNode;b.pendingContext?oe(a,b.pendingContext,b.pendingContext!==b.context):b.context&&oe(a,
...
function kf(a){function b(a){Qb=ja=!0;var b=a.stateNode;b.current===a?E$1("177"):void 0;b.isReadyForCommit=!1;id$1.current=null;if(1<a.effectTag)if(null!==a.lastEffect){a.lastEffect.nextEffect=a;var c=a.firstEffect;}else c=a;else c=a.firstEffect;yg();for(t=c;null!==t;){var d=!1,e=void 0;try{for(;null!==t;){var f=t.effectTag;f&16&&zg(t);if(f&128){var g=t.alternate;null!==g&&Ag(g);}switch(f&-242){case 2:Ne(t);t.effectTag&=-3;break;case 6:Ne(t);t.effectTag&=-3;Oe(t.alternate,t);break;case 4:Oe(t.alternate,
...
if(null!==c)a=c;else{a.stateNode.isReadyForCommit=!0;break}}return null}function d(a){var b=rg(a.alternate,a,H);null===b&&(b=c(a));id$1.current=null;return b}function e(a){var b=Gg(a.alternate,a,H);null===b&&(b=c(a));id$1.current=null;return b}function f(a){if(null!==R){if(!(0===H||H>a))if(H<=Uc)for(;null!==F;)F=k(F)?e(F):d(F);else for(;null!==F&&!A();)F=k(F)?e(F):d(F);}else if(!(0===H||H>a))if(H<=Uc)for(;null!==F;)F=d(F);else for(;null!==F&&!A();)F=d(F);}function g(a,b){ja?E$1("243"):void 0;ja=!0;a.isReadyForCommit=
...
null;null!==b&&Ob(b);return a.isReadyForCommit?a.current.alternate:null}function h(a,b){var c=id$1.current=null,d=!1,e=!1,f=null;if(3===a.tag)c=a, q(a)&&(eb=!0);else for(var g=a["return"];null!==g&&null===c;){2===g.tag?"function"===typeof g.stateNode.componentDidCatch&&(d=!0, f=jd(g), c=g, e=!0):3===g.tag&&(c=g);if(q(g)){if(Sc||null!==ha&&(ha.has(g)||null!==g.alternate&&ha.has(g.alternate)))return null;c=null;e=!1;}g=g["return"];}if(null!==c){null===qa&&(qa=new Set);qa.add(c);var h="";g=a;do{a:switch(g.tag){case 0:case 1:case 2:case 5:var k=
...
var isNode$3 = _cof(process$2) == 'process';
...
var _microtask = function () {
  ...
  var flush = function () {
    var parent, fn;
    if (isNode$3 && (parent = process$2.domain)) parent.exit();
    while (head) {
      fn = head.fn;
      head = head.next;
      try {
...
var isNode$2 = _classof(process) == 'process';
var empty = function () { /* empty */ };
var Internal;
...
if (!USE_NATIVE$1) {
  ...
  Internal.prototype = _redefineAll($Promise.prototype, {
    ...
    then: function then(onFulfilled, onRejected) {
      ...
      reaction.domain = isNode$2 ? process.domain : undefined;
...
var store$1 = createStore(reducers);

var precondition = function precondition(condition) {
  var message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Unmet precondition";
...
var buildHeaders = function buildHeaders(token) {
  ...
  if (token) {
    return _extends$1({}, headers, { Authorization: 'Bearer ' + token });
  } else {
    return headers;
  }
};

var FetchJSON = connect(function (_ref3, props) {
  var fetch_list = _ref3.fetch_list;

  var fetch_object = fetch_list.find(function (obj) {
    return obj.url === props.url;
  });
  var disabled = fetch_object && fetch_object.status === 'loaded';
  ...
  _createClass(_class, [{
    ...
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var _props, _props$method, method, _props$params, params, _props$token, token, action, url_for_this_request, body, headers, result, data;

        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _props = this.props, _props$method = _props.method, method = _props$method === undefined ? 'get' : _props$method, _props$params = _props.params, params = _props$params === undefined ? null : _props$params, _props$token = _props.token, token = _props$token === undefined ? "" : _props$token, action = _props.action;
                url_for_this_request = this.props.url;
                body = params ? serialize(params) : params;
                headers = new Headers(buildHeaders(token));
                _context.prev = 4;
                _context.next = 7;
    ...
    value: function componentDidMount() {
      precondition(this.props.method !== 'post', "POST request not yet implemented");
    ...
    value: function render() {
      var getFetchState = function getFetchState(fetch_object) {
        if (fetch_object) {
          var url = fetch_object.url,
              others = fetch_object.others;
...
var CacheProvider = function CacheProvider(props) {
  return react.createElement(
    Provider,
    { store: store$1 },
    react.createElement(FetchJSON, props)
  );
};

var Dogs = function (_React$Component) {
  _inherits(Dogs, _React$Component);

  function Dogs() {
    _classCallCheck(this, Dogs);

    return _possibleConstructorReturn(this, (Dogs.__proto__ || _Object$getPrototypeOf(Dogs)).apply(this, arguments));
  }
...
reactDom_1(react.createElement(Dogs, null), document.getElementById('app'));
